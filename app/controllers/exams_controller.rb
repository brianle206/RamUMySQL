  ...
  def generate_assertion
    ...
    if @users_exam.score >= 85.00
      ...
      begin
        ...
        puts "Badge: #{badge}"
        @assertion = Assertion.new( user_id: current_user.id, badge_id: @badge.id, recipient: recipient, badge: badge, issued_on: Date.current.iso8601, expires: (Date.current + 2.years).iso8601 )
        ...
        @assertion.update( verify: { type: "hosted", url: "http://frozen-dawn-78535.herokuapp.com/assertions/#{@assertion.id}/#{@assertion.uid}.json" })
