  ...
  def generate_assertion
    ...
    if @users_exam.score >= 85.00
      ...
      begin
        ...
        puts "Badge: #{badge}"
        @assertion = Assertion.new( user_id: current_user.id, badge_id: @badge.id, recipient: recipient, badge: badge, issued_on: (Time.zone.now).to_i, expires: (Time.zone.now + 2.years).to_i )
